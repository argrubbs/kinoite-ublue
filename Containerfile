...
RUN rpm-ostree install distrobox just tailscale asusctl supergfxctl gstreamer1-plugin-openh264 mozilla-openh264 code-1.75.1-1675893486.el7.x86_64.rpm 1password-latest.rpm   && \
